            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Pendings</h1>
                        ...
                        <table class="table table-bordered table-hover table-condensed">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>25-10-2025</td>
                                    <td class="text-center"><a href="#" class="btn btn-success btn-sm" title="Terima"><i class="fas fa-check"></i></a></td>
                                    <td class="text-center"><a href="#" class="btn btn-danger btn-sm px-2" title="Tolak"><i class="fas fa-times"></i><a></td>
                                </tr>
                                <tr>
                                    <td>2</td>
