...
CREATE TABLE `staf` (
  ...
  `staf_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `staf_email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `staf_number` int NOT NULL,
  `staf_unit` enum('dosen_informatika','dosen_manajemen','dosen_elektro','dosen_mesin') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
...
CREATE TABLE `unit` (
  ...
  `unit_email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `visit_data` (
  ...
  `visit_regards` enum('Urusan_surat','Urusan_keuangan','Urusan_umum','Urusan_sarana','Janji_temu_unit','Janji_temu_staf') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `visit_desc` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_unit` int DEFAULT NULL,
  `id_staf` int DEFAULT NULL,
  `visit_date` date NOT NULL,
  `time_in` time NOT NULL,
  `time_out` time NOT NULL,
  `appointment` enum('Ya','Tidak') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `status` enum('Pending','Done','Upcoming') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
